$(function() {
  ...
  var $val = "";
	...
	ref.on('child_added', function(snapshot) {
  	...
  	$('.incoming-list').append('<p class=' + snapshot.key + ' id='+ snapshot.val().type + '>' + snapshot.val().message + '<button class=button_' + snapshot.key + ' id="accept">Accept</button></p><div class="divider"></div>');
